...
probs[["PRESS"]] = list(
  c(0.97, 0.01, 0.01, 0.01),
  c(0.01, 0.30, 0.49, 0.20),
  c(0.01, 0.01, 0.08, 0.90),
  c(0.01, 0.01, 0.01, 0.97),
  c(0.97, 0.01, 0.01, 0.01),
  c(0.10, 0.84, 0.05, 0.01),
  c(0.05, 0.25, 0.25, 0.45),
  c(0.01, 0.15, 0.25, 0.59),
  c(0.97, 0.01, 0.01, 0.01),
  c(0.01, 0.29, 0.30, 0.40),
  c(0.01, 0.01, 0.08, 0.90),
  c(0.01, 0.01, 0.01, 0.97),
  c(0.97, 0.01, 0.01, 0.01),
  c(0.01, 0.97, 0.01, 0.01),
  ...
  c(0.01, 0.01, 0.01, 0.97),
  c(0.97, 0.01, 0.01, 0.01),
  c(0.40, 0.58, 0.01, 0.01),
  c(0.20, 0.75, 0.04, 0.01),
  c(0.20, 0.70, 0.09, 0.01),
  c(0.97, 0.01, 0.01, 0.01),
  c(0.01, 0.90, 0.08, 0.01),
  c(0.01, 0.01, 0.38, 0.60),
  c(0.01, 0.01, 0.01, 0.97))
